const URL = "./model6/"; // Base URL for model files
...
function generateTreatmentRecommendation(className) {
  switch (className) {
    case "Chance of No Kidney Cancer":
      return "No signs of kidney cancer detected. Maintain a healthy lifestyle and schedule regular checkups.";
    case "Chance of Kidney Cancer":
      return "Recommended Treatment: Consult an oncologist for further tests and a detailed diagnosis. Treatment options may include surgery, targeted therapy, immunotherapy, or, in some cases, radiation therapy, depending on the stage and type of kidney cancer. Chemotherapy is less commonly used but may be considered in certain situations. Early intervention is crucial for the best outcomes.";
    default:
