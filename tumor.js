const URL = "./model/"; // Base URL for model files
...
function generateTreatmentRecommendation(className) {
  switch (className) {
    case "Chance of No Brain Tumor":
      return "No tumor detected. Maintain a healthy lifestyle and schedule regular checkups.";
    case "Chance of Meningioma Brain Tumor":
      return "Recommended Treatment: MRI monitoring, possible surgery, or radiation therapy depending on size and location. Consult a neurosurgeon.";
    case "Chance of Pituitary Brain Tumor":
      return "Recommended Treatment: Hormonal therapy, medication, or surgery based on tumor type and symptoms. Consult an endocrinologist.";
    default:
